...
public class delete extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int a=JOptionPane.showConfirmDialog(null,"Do you really want to delete this user?","Select",JOptionPane.YES_NO_CANCEL_OPTION);
        if(a==0){
            ...
            try{
                ...
                st.executeUpdate("delete from worker where WorkerID='"+id+"'");
